<div class="container relative mt-28">
    <div class="grid md:grid-cols-2 grid-cols-1 gap-6 mt-6">
        ...
        <div class="rounded-md shadow dark:shadow-gray-700 p-6 bg-white dark:bg-slate-900 h-fit">
            <form id="ads-create" action="{{ '#' }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-12 gap-5">
                    <div class="col-span-12">
                        ...
                        <div class="form-icon relative mt-2">
                            <i class="fa-solid fa-t text-xl absolute top-7 left-3 -translate-y-1/2 text-white-500"></i>
                            <input name="title" id="title" type="text" class="form-input pl-9 mt-2"
                    ...
                    <div class="md:col-span-12 col-span-12">
                        ...
                        <div class="form-icon relative mt-2">
                            <i class="fa-regular fa-clipboard text-xl absolute top-5 left-3 -translate-y-1/2 text-white-500"></i>
                    ...
                    <div class="col-span-12">
                        ...
                        <div class="form-icon relative mt-2">
                            <select
                                ...
                                <option selected disabled hidden>Yashovchilar jinsi</option>
